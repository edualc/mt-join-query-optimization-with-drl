...
class CM1PostgresCardJob3(gym.Env):
  ...
  def __init__(self):
    ...
    self.sql_query = list(open(get_queries('crossval_sens/job_queries_simple_crossval_3_test.txt')))
  ...
  def reset(self):
    ...
    # sql_query = random.choice(list(open(get_queries('crossval_sens/job_queries_simple_crossval_3_train.txt')))).replace(";", "")
